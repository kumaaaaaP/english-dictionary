...
function startExercise() {{
    ...
    let thresholds = Object.keys(GROUPED_CHAPTERS).flatMap(g => GROUPED_CHAPTERS[g].map(ch => parseInt(ch.id))).sort((a,b)=>a-b);
...
loadAllData();
    ...
    print("✓ exercise.html has been generated with Home button and new Layout.")
